...
export default function CollegeVerificationsPage() {
  ...
  if (authLoading || loading) {
    return (
      <div className="cf-page-shell">
        <div className="cf-loading-card">Loading verifications...</div>
      </div>
    );
  }
    ...
    return (
      <div className="cf-page-shell">
        <div className="cf-access-card">
          ...
          <p>Only Super Admin can access this verification review page.</p>
  ...
  return (
    <div className="cf-page-shell">
      <section className="cf-verification-hero">
        <div>
          <div className="cf-kicker">Super Admin Review</div>

          <h1>All Student Verifications</h1>

          <p>
            Review pending student verification requests across the platform.
            College approval remains separate and must be handled only by Super
            Admin.
          </p>
        </div>
            ...
            <article key={verification._id} className="cf-verification-card">
              ...
              <div className="cf-project-info-grid">
                ...
                <div>
                  ...
                  <strong>{verification.collegeId?.domain || "N/A"}</strong>
                </div>
              ...
              <div className="cf-id-card-review">
                ...
                {verification.idCardImage ? (
                  ...
                  <p className="cf-danger-text">ID card image not available.</p>
                )}
              </div>
